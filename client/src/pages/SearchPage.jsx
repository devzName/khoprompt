        ...
        {initialLoading ? (
          ...
          <div className="flex justify-center items-center min-h-[60vh] bg-white dark:bg-[#141414] rounded-lg">
            <div className="text-center p-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('search.enterKeyword')}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm">{t('search.enterKeywordDesc')}</p>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center min-h-[60vh] bg-white dark:bg-[#141414] rounded-lg">
            <div className="text-center p-8">
              <SearchOutlined style={{ fontSize: '4rem', color: '#d1d5db', display: 'block', margin: '0 auto 1rem' }} />
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('search.noResults')}</h3>
          ...
          <div className="relative">
            {loading && (
              <div className="absolute inset-0 bg-white dark:bg-[#141414] bg-opacity-80 dark:bg-opacity-80 flex justify-center items-center z-10 rounded-lg backdrop-blur-sm">
                <div className="bg-white dark:bg-[#141414] rounded-lg shadow-lg p-4 flex items-center gap-3">
                  <Spin size="default" />
                  <span className="text-gray-600 dark:text-gray-300">{t('search.loadingPage', { page: currentPage })}</span>
                </div>
              </div>
            )}
